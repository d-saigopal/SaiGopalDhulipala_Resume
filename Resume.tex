...
\section*{\begin{large}\textbf{OBJECTIVE}\end{large}}
...
\section*{\begin{large}\textbf{EDUCATION}\end{large}}
\begin{table}[h]
...
\section*{\begin{large}\textbf{PROJECTS}\end{large}}
\begin{enumerate}
\item Created a \textbf{Smart Garbage Monitoring System} which has WiFi connectivity, Bluetooth connectivity, an RFID Reader unit, garbage level monitoring unit, a display unit, an automatic mouth opening and closing system. Also created an Android app which shows the current status of all the bins in the city. Participated and got first position in national level event ``Micrologic" during
...
\section*{\begin{large}\textbf{TRAINING}\end{large}}
\begin{itemize}
...
\section*{\begin{large}\textbf{TECHNICAL SKILLS}\end{large}}
\begin{itemize}
...
\section*{\begin{large}\textbf{SOFT SKILLS}\end{large}}
\begin{enumerate}
...
\section*{\begin{large}\textbf{EXTRA CIRRICULAR ACTIVITIES}\end{large}}
\begin{itemize}
...
\section*{\begin{large}\textbf{Co-CIRRICULAR ACTIVITIES}\end{large}}
\begin{enumerate}
...
\section*{\begin{large}\textbf{PERSONAL INFORMATION}\end{large}}
...
\section*{\begin{large}\textbf{LANGUAGES KNOWN}\end{large}}
Telugu, Hindi, English

\section*{\begin{large}\textbf{REFERENCES}\end{large}}
\begin{enumerate}
...
\section*{\begin{large}\textbf{DECLARATION}\end{large}}
I hereby declare that the above information is accurate to the best of my knowledge.\\
---Sai Gopal

\section*{\begin{large}\textbf{DATE}\end{large}}
23-04-2017
